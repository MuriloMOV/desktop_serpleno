...
from ser_pleno.repositories.metas import MetaRepository
...
class ServicoMetas:
    ...
    def listar_metas(self, student_id=None, status=None, category=None, priority=None, pagina=1):
        ...
        return with_api_fallback(
            _api_call,
            self._listar_metas_local,
            student_id, status, category, priority,
        )
    ...
    def registrar_progresso(self, id_meta, percentage, notes, recorded_by_id):
        ...
        return with_api_fallback(
            _api_call,
            self._fallback_registrar_progresso,
            id_meta,
            percentage,
            notes,
            recorded_by_id,
