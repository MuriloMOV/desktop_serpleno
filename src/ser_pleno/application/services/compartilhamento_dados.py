...
class ServicoCompartilhamentoDadosClinicos:
    ...
    def listar_compartilhamentos(
        ...
        return with_api_fallback(
            _api_call,
            self._listar_compartilhamentos_local,
            busca,
            data_type,
            student_id,
            page,
    ...
    def descompartilhar(self, dados: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return with_api_fallback(
            _api_call,
            self._fallback_descompartilhar,
            dados,
        )
    ...
    def listar_estudantes_compartilhados(self) -> Dict[str, Any]:
        ...
        return with_api_fallback(
            _api_call,
            self._listar_estudantes_compartilhados_local,
        )
    ...
    def obter_historico_compartilhamento(self, student_id: int) -> Dict[str, Any]:
        ...
        return with_api_fallback(
            _api_call,
            self._fallback_obter_historico_compartilhamento,
            student_id,
        )
    ...
    def obter_relatorio_compartilhamento(self) -> Dict[str, Any]:
        ...
        return with_api_fallback(
            _api_call,
            self._fallback_obter_relatorio_compartilhamento,
        )
    ...
    @property
    def _repo(self):
        from ser_pleno.repositories.compartilhamento_dados import CompartilhamentoDadosRepository
