...
from ser_pleno.repositories.report_templates import ReportTemplateRepository
...
class ServicoReportTemplate:
    ...
    def listar_templates(self, tipo: Optional[str] = None, apenas_ativos: bool = True) -> List[Dict[str, Any]]:
        ...
        def _fallback(tipo=None, apenas_ativos=True):
            rows = self.repo.listar_templates(tipo, apenas_ativos)
            return {"success": True, "data": rows}

        return with_api_fallback(_api_call, _fallback, tipo, apenas_ativos)
    ...
    def criar_template(self, dados: Dict[str, Any]) -> Dict[str, Any]:
        ...
        def _fallback(nome=None, report_type=None, template_config=None, default_parameters=None, is_active=True, created_by_id=1):
        ...
        return with_api_fallback(_api_call, _fallback, nome, report_type, template_config, default_parameters, is_active, created_by_id)
    ...
    def atualizar_template(self, id_template: int, dados: Dict[str, Any]) -> Dict[str, Any]:
        ...
        def _fallback(id_template=None, nome=None, report_type=None, template_config=None, default_parameters=None, is_active=None):
        ...
        return with_api_fallback(_api_call, _fallback, id_template, nome, report_type, template_config, default_parameters, is_active)
