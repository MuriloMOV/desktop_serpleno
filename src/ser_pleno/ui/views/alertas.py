...
class AlertasFrame(ctk.CTkFrame):
    ...
    def _marcar_lido(self, alerta):
        def _fetch():
            return self.servico_alertas.marcar_alerta_lido(alerta.get("id"))
    ...
    def _dispensar(self, alerta):
        def _fetch():
            return self.servico_alertas.dispensar_alerta(alerta.get("id"))
    ...
    def _marcar_todos_lidos(self):
        def _fetch():
            return self.servico_alertas.marcar_todos_lidos()
