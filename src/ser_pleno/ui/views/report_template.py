...
class ReportTemplateFrame(ctk.CTkFrame):
    ...
    def carregar_templates_async(self):
        ...
        def _fetch():
            return self.servico_report_template.listar_templates(tipo=self._filtro_tipo or None, apenas_ativos=True)
    ...
    def _preview(self, template):
        def _fetch():
            return self.servico_report_template.gerar_preview(template.get("id"))
