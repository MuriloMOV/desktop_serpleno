...
from ser_pleno.infrastructure.api.client import set_auth_service as set_auth_service_api
from ser_pleno.ui.theme import THEME, RADIUS, themed_font
from ser_pleno.presentation.components.ui_components import PrimaryButton, GhostButton, Divider
...
def _build_login_palette() -> dict:
    ...
    voltasse Ó  tela de login, ela continuaria usando cores antigas para
...
class LoginInputField(ctk.CTkFrame):
    ...
    def __init__(self, parent, label: str, placeholder: str = "",
        ...
        if password:
            self._eye_btn = ctk.CTkButton(
                self._box, text="ðŸ‘", width=36, height=36,
    ...
    def set_error(self, msg: str = ""):
        ...
        self._msg.configure(text=f"âš   {msg}" if msg else "", text_color=THEME["danger"])
    ...
    def _toggle_show(self):
        ...
        self._eye_btn.configure(text="ðŸ™ˆ" if self._show_pass else "ðŸ‘")
...
class LoginFrame(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        # ou seja, refazendo um trabalho idêntico repetidamente Ó  toa).
    ...
    def _criar_card_login(self):
        ...
        ctk.CTkLabel(
            badge, text="Acesso seguro Â· Plataforma SerPleno",
            font=themed_font("caption", "bold"),
        ...
        ctk.CTkLabel(icon_bg, text="ðŸ§ ", font=themed_font("h2")).place(relx=0.5, rely=0.5, anchor="center")
        ...
        for text in ["ðŸ”’ LGPD", "âš¡ Acesso rápido", "ðŸ¤ Apoio contínuo"]:
        ...
        self.input_user = LoginInputField(inner, "Usuário", placeholder="Seu nome de usuário", icon="ðŸ‘¤")
        self.input_user.pack(fill="x", pady=(0, 12))

        self.input_pass = LoginInputField(inner, "Senha", placeholder="Sua senha", icon="ðŸ”’", password=True)
        ...
        GhostButton(
            inner, text="ðŸ”’  Política de Privacidade", command=self._abrir_politica,
    ...
    def _toggle_music(self):
        ...
        if not is_playing:
            ...
            try:
                ...
                self._music_btn.configure(text="â™¬", text_color=THEME["primary"])
            ...
            try:
                ...
                self._music_playing = False
                self._music_btn.configure(text="â™ª", text_color=THEME["text_secondary"])
            except Exception:
                pass
    ...
    def _on_login_failure(self, msg):
        self._is_loading = False
        self._set_idle_state()
        self.lbl_erro.configure(text=f"âœ•  {msg}", text_color=self.palette["danger"])
    ...
    def _abrir_politica(self):
        ...
        icon_bg.pack_propagate(False)
        ctk.CTkLabel(icon_bg, text="ðŸ”’", font=themed_font("h3")).place(relx=0.5, rely=0.5, anchor="center")
        ...
        ctk.CTkLabel(
            ...
            text=(
                ...
                "de informaçÓµes pessoais e acadêmicas durante o uso da\n"
                "plataforma."
            ),
            font=themed_font("body"),
            text_color=self.palette["text_muted"],
