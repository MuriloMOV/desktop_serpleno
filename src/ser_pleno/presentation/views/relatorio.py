...
_CHIP = {
    ...
    "IntervençÓµes":  (THEME["kpi_violet_soft"],    THEME["kpi_violet"]),
...
_KPIS = [
    ("Estudantes",    "ðŸŽ“", THEME["kpi_blue"],   THEME["kpi_blue_soft"],   "students_total"),
    ("Agendamentos",  "ðŸ“…", THEME["kpi_green"],  THEME["kpi_green_soft"],  "appointments_total"),
    ("IntervençÓµes",  "ðŸ¤", THEME["kpi_violet"], THEME["kpi_violet_soft"], "interventions_total"),
    ("Triagens",      "ðŸ”", THEME["kpi_amber"],  THEME["kpi_amber_soft"],  "screenings_total"),
]
...
class RelatorioFrame(ctk.CTkScrollableFrame):
        ...
        if stats_res.get("success"):
            ...
            for _, _, _, _, key in _KPIS:
                title_map = {
                    ...
                    "interventions_total": "IntervençÓµes",
    ...
    def _criar_card_grafico(self, parent):
        ...
        for label, color in [
            ...
            ("IntervençÓµes", THEME["chart_bar_2"]),
    ...
    def _criar_card_resumo(self, parent):
        ...
        rows_cfg = [
            ...
            ("intervencoes_30d",  "IntervençÓµes (30d)",     THEME["text"],           None),
    ...
    def _criar_secao_exportacao(self):
        ...
        ctk.CTkLabel(
            hdr, text="ðŸ“¥  Exportação de Dados",
            font=themed_font("body", "bold"),
            text_color=THEME["text"],
        ).pack(side="left")
        ...
        exports = [
            ("ðŸ“‹  Estudantes",    "CSV",  self.servico_relatorio.exportar_estudantes,    THEME["kpi_blue"],   THEME["kpi_blue_soft"]),
            ("ðŸ“…  Agenda",        "CSV",  self.servico_relatorio.exportar_agendamentos,   THEME["kpi_green"],  THEME["kpi_green_soft"]),
            ("ðŸ”  Triagens",      "CSV",  self.servico_relatorio.exportar_triagens,       THEME["kpi_amber"],  THEME["kpi_amber_soft"]),
            ("ðŸ“Š  Relatório PDF", "PDF",  lambda: None,                                   THEME["kpi_violet"], THEME["kpi_violet_soft"]),
        ]
    ...
    def _criar_lista_relatorios(self):
        ...
        self.filtro_tipo = ctk.CTkOptionMenu(
            ...
            values=["Todos os tipos", "Geral", "Estudante",
                    "Agendamentos", "IntervençÓµes", "Triagens", "Estatísticas"],
            font=themed_font("body"),
        ...
        for i, txt in enumerate(["Nome do Relatório", "Tipo", "Data", "AçÓµes"]):
            ctk.CTkLabel(
                col_hdr, text=txt,
                font=themed_font("body_sm", "bold"),
                text_color=THEME["text_secondary"], anchor="w",
    ...
    def _criar_row_relatorio(self, report: dict):
        ...
        for icon, tip, cmd in [
            ("ðŸ‘", "Visualizar", lambda: None),
            ("ðŸ“¥", "Baixar",     lambda: None),
            ("ðŸ—‘", "Excluir",    lambda: None),
        ]:
            GhostButton(
                actions, text=icon,
