...
_MOOD_LABEL = {1: "Muito triste", 2: "Triste", 3: "Neutro", 4: "Bem", 5: "Ó“timo"}
...
class BemEstarFrame(ctk.CTkScrollableFrame):
    ...
    def _criar_kpis(self):
        ...
        kpis = [
            ("Humor Médio",       "ðŸ˜Š  —",  "ðŸ’š", THEME["kpi_blue"],  THEME["kpi_blue_soft"],  "_kpi_humor",
             "Média dos últimos 7 dias"),
            ("Participação",      "—%",    "ðŸ“ˆ", THEME["kpi_pink"],  THEME["kpi_pink_soft"],  "_kpi_part",
             "Taxa de check-ins"),
            ("Alertas Críticos",  "—",     "ðŸš¨", THEME["kpi_red"],   THEME["kpi_red_soft"],   "_kpi_crit",
    ...
    # ••••••••••••••••••••••••••••••••••••••
    #  GRÓFICO DE TENDÓŠNCIA
    # ••••••••••••••••••••••••••••••••••••••
    def _criar_secao_grafico(self):
        outer = _section_card(self, "ðŸ“ˆ  Tendência de Bem-Estar — últimos 30 dias")
        ...
        for label, color, pct_key, default in [
            ("ðŸ˜Š  Bom",     THEME["success"], "bom",  65),
            ("ðŸ˜  Neutro",  THEME["warning"], "med",  25),
            ("ðŸ˜¢  Baixo",   THEME["danger"],  "mau",  10),
        ]:
    ...
    # ••••••••••••••••••••••••••••••••••••••
    #  VISÓƒO DE RISCO (kanban 4 colunas)
    # ••••••••••••••••••••••••••••••••••••••
    def _criar_visao_risco(self):
        ...
        ctk.CTkLabel(
            title_row, text="ðŸ›¡  Visão de Risco dos Estudantes",
    ...
    def _criar_lista_checkins(self):
        outer = _section_card(self, "ðŸ“  Check-ins Recentes")
