...
# ••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••
#  Design tokens – mapeamentos semÓ¢nticos específicos da triagem
# ••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••
...
_COL_HEADERS = ["Estudante", "Data", "Prioridade", "Status", "AçÓµes"]
...
class AnaliseTriagemFrame(ctk.CTkScrollableFrame):
    ...
    def _criar_kpis(self):
        ...
        kpis = [
            ("Total de Triagens", str(total),     "ðŸ“‹", THEME["kpi_blue"],  THEME["kpi_blue_soft"],  "Registros"),
            ("Pendentes",         str(pendentes),  "â³", THEME["kpi_amber"], THEME["kpi_amber_soft"], "Aguardando"),
            ("Concluídas",        str(concluidas), "âœ…", THEME["kpi_green"], THEME["kpi_green_soft"], "Finalizadas"),
            ("Alta Prioridade",   str(alta_p),     "âš ï¸", THEME["kpi_red"],   THEME["kpi_red_soft"],   "Urgente ou Alta"),
        ]
    ...
    def _criar_filtros(self):
        ...
        ctk.CTkLabel(hdr, text="ðŸ”½  Filtrar Triagens",
    ...
    def renderizar_tabela(self, data_list: list):
        ...
        if not data_list:
            ...
            ctk.CTkLabel(empty, text="ðŸ“­  Nenhuma triagem encontrada",
                         font=themed_font("body"),
    ...
    def _criar_row(self, item: dict):
        ...
        for icon, cmd, tip in [("ðŸ‘", lambda s=item: self._ver_detalhe(s), "Ver detalhe"),
                                ("âœ", lambda s=item: self._editar(s), "Editar")]:
            GhostButton(
    ...
    def abrir_nova_triagem(self):
        ...
        en_nome  = field(body, "Nome do Estudante", "Ex: Ana Silva", "ðŸ‘¤")
        en_data  = field(body, "Data da Triagem",   "dd/mm/aaaa",   "ðŸ“…")
        ...
        en_obs = ctk.CTkTextbox(body, height=80, corner_radius=RADIUS["input"],
                                ...
                                font=themed_font("body"))
        en_obs.pack(fill="x")
        en_obs.insert("0.0", "ObservaçÓµes...")
        ...
        PrimaryButton(
            footer, text="âœ”  Salvar", command=salvar,
