...
class PedidosAjudaFrame(BaseViewFrame):
    ...
    def _verificar_novos_pedidos(self):
        ...
        try:
            count = self.controller.contar_pendentes()
    ...
    def carregar_pedidos_async(self):
        ...
        def _fetch():
            return self.controller.listar_pedidos(status=self._get_status_filtro())
    ...
    def _acao_marcar_visto(self, pedido_id):
        def _fetch():
            return self.controller.marcar_visto(pedido_id)
    ...
    def _acao_iniciar(self, pedido_id):
        def _fetch():
            return self.controller.iniciar_atendimento(pedido_id)
    ...
    def _acao_resolver(self, pedido_id):
        def _fetch():
            return self.controller.resolver_pedido(pedido_id)
    ...
    def _on_responder_enviar(self, pedido_id, resposta):
        def _fetch():
            return self.controller.responder_pedido(pedido_id, resposta)
