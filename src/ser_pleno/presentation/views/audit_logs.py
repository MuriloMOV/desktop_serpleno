...
from ser_pleno.presentation.views.base import BaseViewFrame, _ErrorModal
...
class AuditLogsFrame(BaseViewFrame):
    ...
    def load_data(self):
        ...
        def fetch():
            ...
            logs_data = self.controller.listar_logs(filtros)
            stats_data = self.controller.obter_estatisticas(filtros)
