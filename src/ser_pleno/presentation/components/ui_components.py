...
Todas as classes e funçÓµes públicas mantêm a mesma assinatura e API do
arquivo original — nenhum call-site do resto da aplicação precisa mudar.

Correção estrutural desta revisão
----------------------------------
Vários componentes usavam cores do tema como *valor padrão de parÓ¢metro*,
por exemplo:
...
class PageHeader(ctk.CTkFrame):
    """Cabeçalho de página com título, subtítulo, breadcrumb e açÓµes."""
...
class _BaseIconButton(ctk.CTkButton):
    """Base para botÓµes que suportam texto, ícone e tooltip."""
...
class InputField(ctk.CTkFrame):
    ...
    def _show_error(self, msg: str):
        self._status_icon.configure(text="âš ", text_color=THEME["danger"])
    ...
    def set_success(self):
        ...
        self._status_icon.configure(text="âœ”", text_color=THEME["success"])
        self._status_icon.pack(side="right", padx=(8, 0))
...
class SearchField(ctk.CTkFrame):
    ...
    def _build(self, placeholder):
        ...
        ctk.CTkLabel(self, text="ðŸ”", font=themed_font("body"),
        ...
        self._clear = ctk.CTkButton(self, text="âœ•", width=22, height=22,
...
class Badge(ctk.CTkFrame):
    """Selo/chip para notificaçÓµes e status."""
...
class Toast(ctk.CTkFrame):
    ...
    def __init__(self, parent, message: str, status: str = "info",
        ...
        icons = {"info": "â„¹", "success": "âœ”", "warning": "âš ", "danger": "âœ•"}
        colors = {
    ...
    def _close(self, parent) -> ctk.CTkButton:
        return ctk.CTkButton(parent, text="âœ•", width=24, height=24,
...
class Dropdown(ctk.CTkOptionMenu):
    """Menu de opçÓµes estilizado com largura fixa."""
...
class RadioGroup(ctk.CTkFrame):
    """Grupo de botÓµes de opção (radio) customizado."""
