...
class ServicoEstudante:
    ...
    @api_fallback("_listar_estudantes_local")
    ...
    @api_fallback("_fallback_obter_estudante")
    ...
    @api_fallback("_fallback_obter_relatorio_estudante")
    ...
    @api_fallback("_fallback_criar_estudante")
    ...
    @api_fallback("_fallback_atualizar_estudante")
    ...
    @api_fallback("_fallback_deletar_estudante")
    ...
    @api_fallback("_fallback_bloquear_minigames")
    ...
    @api_fallback("_fallback_desbloquear_minigames")
    ...
    @api_fallback("_fallback_verificar_comportamento_suspeito")
    ...
    @api_fallback("_fallback_obter_log_bloqueio")
