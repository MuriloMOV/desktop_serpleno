...
class TestPedidosAjudaRepository:
    @patch("ser_pleno.features.pedidos_ajuda.repo.fetch_all")
    def test_listar_pedidos_ajuda_sem_filtro(self, mock_fetch_all):
        ...
        with patch("ser_pleno.features.pedidos_ajuda.repo.get_operation_config") as mock_cfg:
    ...
    @patch("ser_pleno.features.pedidos_ajuda.repo.write_with_fallback")
    ...
    @patch("ser_pleno.features.pedidos_ajuda.repo.PedidosAjudaRepository.listar_pedidos_ajuda")
