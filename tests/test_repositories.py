...
class TestEstudanteRepository:
    @patch("ser_pleno.features.estudantes.repo.fetch_all")
    ...
    @patch("ser_pleno.features.estudantes.repo.fetch_one")
    ...
    @patch("ser_pleno.features.estudantes.repo.write_with_fallback")
...
class TestAgendamentoRepository:
    @patch("ser_pleno.features.agenda.repo.fetch_all")
    ...
    @patch("ser_pleno.features.agenda.repo.fetch_one")
    ...
    @patch("ser_pleno.features.agenda.repo.execute_non_query")
...
class TestBemEstarRepository:
    @patch("ser_pleno.features.bem_estar.repo.fetch_all")
    ...
    @patch("ser_pleno.features.bem_estar.repo.fetch_one")
...
class TestTriagemRepository:
    @patch("ser_pleno.features.triagem.repo.fetch_all")
    def test_listar(self, mock_fetch_all):
        mock_fetch_all.return_value = []
    ...
    @patch("ser_pleno.features.triagem.repo.fetch_one")
    def test_obter(self, mock_fetch_one):
    ...
    @patch("ser_pleno.features.triagem.repo.write_with_fallback")
    def test_criar(self, mock_write):
        mock_write.return_value = 1
        repo = TriagemRepository()
...
class TestComunicacaoRepository:
    @patch("ser_pleno.features.comunicacao.repo.fetch_all")
    ...
    @patch("ser_pleno.features.comunicacao.repo.write_with_fallback")
    ...
    @patch("ser_pleno.features.comunicacao.repo.fetch_one")
...
class TestConfiguracoesRepository:
    @patch("ser_pleno.features.configuracoes.repo.fetch_all")
    ...
    @patch("ser_pleno.features.configuracoes.repo.write_with_fallback")
...
class TestRelatorioRepository:
    @patch("ser_pleno.features.relatorio.repo.fetch_all")
    ...
    @patch("ser_pleno.features.relatorio.repo.fetch_one")
    ...
    @patch("ser_pleno.features.relatorio.repo.write_with_fallback")
...
class TestOrientacaoRepository:
    @patch("ser_pleno.features.orientacoes.repo.fetch_all")
    ...
    @patch("ser_pleno.features.orientacoes.repo.fetch_one")
    ...
    @patch("ser_pleno.features.orientacoes.repo.write_with_fallback")
